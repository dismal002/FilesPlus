...
package com.dismal.files.provider

import java8.nio.file.Files
import java8.nio.file.ProviderNotFoundException
import java8.nio.file.spi.FileSystemProvider
import com.dismal.files.provider.archive.ArchiveFileSystemProvider
import com.dismal.files.provider.common.AndroidFileTypeDetector
import com.dismal.files.provider.content.ContentFileSystemProvider
import com.dismal.files.provider.document.DocumentFileSystemProvider
import com.dismal.files.provider.ftp.FtpFileSystemProvider
import com.dismal.files.provider.ftp.FtpesFileSystemProvider
import com.dismal.files.provider.ftp.FtpsFileSystemProvider
import com.dismal.files.provider.linux.LinuxFileSystemProvider
import com.dismal.files.provider.root.isRunningAsRoot
import com.dismal.files.provider.sftp.SftpFileSystemProvider
import com.dismal.files.provider.smb.SmbFileSystemProvider
import com.dismal.files.provider.webdav.WebDavFileSystemProvider
import com.dismal.files.provider.webdav.WebDavsFileSystemProvider
