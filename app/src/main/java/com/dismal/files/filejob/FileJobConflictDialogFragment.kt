...
import com.dismal.files.databinding.FileJobConflictDialogViewBinding
...
import com.dismal.files.file.lastModifiedInstant
import com.dismal.files.filelist.appDirectoryPackageName
import com.dismal.files.filelist.supportsThumbnail
...
import com.dismal.files.util.setTextWithSelection
import com.dismal.files.util.shortAnimTime
import com.dismal.files.util.showSoftInput
...
class FileJobConflictDialogFragment : AppCompatDialogFragment() {
    ...
    /** @see com.dismal.files.filelist.FileListAdapter.onBindViewHolder */
