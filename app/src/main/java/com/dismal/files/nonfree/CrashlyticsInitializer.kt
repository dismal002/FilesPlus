...
package com.dismal.files.nonfree
...
import com.dismal.files.util.getPackageInfoOrNull
...
//#ifdef NONFREE
        ...
        */
//#endif
        // No-op when Firebase is disabled - no tracking or crash reporting
    }

    private fun verifyPackageName(): Boolean {
        return application.packageName == "com.dismal.files"
    }
