...
import com.dismal.files.compat.PreferenceManagerCompat
import com.dismal.files.compat.getDescriptionCompat
import com.dismal.files.compat.readBooleanCompat
import com.dismal.files.compat.writeBooleanCompat
import com.dismal.files.compat.writeParcelableListCompat
import com.dismal.files.file.DocumentTreeUri
import com.dismal.files.file.asExternalStorageUriOrNull
import com.dismal.files.file.displayName
import com.dismal.files.file.storageVolume
import com.dismal.files.filelist.FileSortOptions
import com.dismal.files.navigation.BookmarkDirectory
import com.dismal.files.navigation.StandardDirectorySettings
import com.dismal.files.provider.archive.ArchiveFileSystem
import com.dismal.files.provider.common.ByteString
import com.dismal.files.provider.common.moveToByteString
import com.dismal.files.provider.content.ContentFileSystem
import com.dismal.files.provider.document.DocumentFileSystem
import com.dismal.files.provider.document.resolver.ExternalStorageProviderHacks
import com.dismal.files.provider.linux.LinuxFileSystem
import com.dismal.files.provider.root.RootStrategy
import com.dismal.files.provider.sftp.SftpFileSystem
import com.dismal.files.provider.smb.SmbFileSystem
import com.dismal.files.storage.DocumentTree
import com.dismal.files.storage.FileSystemRoot
import com.dismal.files.storage.PrimaryStorageVolume
import com.dismal.files.util.StableUriParceler
import com.dismal.files.util.asBase64
import com.dismal.files.util.readParcelable
import com.dismal.files.util.readParcelableListCompat
import com.dismal.files.util.toBase64
import com.dismal.files.util.toByteArray
import com.dismal.files.util.use
        ...
        Parcel.obtain().use { newParcel ->
            ...
            Parcel.obtain().use { oldParcel ->
                ...
                repeat(size) {
                    ...
                    oldParcel.readInt()
                    val className = oldParcel.readString()
                    if (className == "com.dismal.files.storage.SmbServer") {
                        newParcel.writeInt(PARCEL_VAL_PARCELABLE)
                        newParcel.writeString("com.dismal.files.storage.SmbServer")
                        ...
                        newParcel.writeString(
                            "com.dismal.files.provider.smb.client.Authority"
                        )
                        ...
                        oldParcel.readString()
                        newParcel.writeString(
                            "com.dismal.files.provider.smb.client.Authentication"
                        )
...
private fun migratePath1_4_0(oldParcel: Parcel, newParcel: Parcel) {
    ...
    when (className) {
        ...
        "com.dismal.files.provider.sftp.SftpPath" ->
            newParcel.writeParcelable(oldParcel.readParcelable<SftpFileSystem>(), 0)
        "com.dismal.files.provider.smb.SmbPath" ->
            ...
            Parcel.obtain().use { oldParcel ->
                ...
                repeat(size) {
                    ...
                    when (oldParcel.readString()) {
                        "com.dismal.files.storage.SftpServer" -> {
                            newParcel.writeInt(PARCEL_VAL_PARCELABLE)
                            newParcel.writeString("com.dismal.files.storage.SftpServer")
                            val id = oldParcel.readLong()
                            newParcel.writeLong(id)
                            val customName = oldParcel.readString()
                            newParcel.writeString(customName)
                ...
                repeat(size) {
                    ...
                    when (oldParcel.readString()) {
                        "com.dismal.files.storage.SftpServer" -> {
                            ...
                            val authenticationPasswordOrPrivateKey = oldParcel.readString()
                            newParcel.writeString(authenticationPasswordOrPrivateKey)
                            if (authenticationClassName == "com.dismal.files.provider.sftp"
                ...
                Parcel.obtain().use { oldParcel ->
                    ...
                    readWriteLengthPrefixedValue(oldParcel, newParcel) {
                        ...
                        repeat(size) {
                            ...
                            oldParcel.setDataPosition(oldPosition)
                            when (className) {
                                "com.dismal.files.storage.DocumentManagerShortcut" -> {
                                    newParcel.writeInt(oldParcel.readInt())
                                    readWriteLengthPrefixedValue(oldParcel, newParcel) {
                                        oldParcel.readString()
                                        newParcel.writeString(
                                            "com.dismal.files.storage" +
