...
import com.dismal.files.coil.AppIconPackageName
import com.dismal.files.compat.foregroundCompat
import com.dismal.files.compat.getDrawableCompat
import com.dismal.files.compat.isSingleLineCompat
import com.dismal.files.databinding.FileItemGridBinding
import com.dismal.files.databinding.FileItemListBinding
import com.dismal.files.file.FileItem
import com.dismal.files.file.fileSize
import com.dismal.files.file.formatShort
import com.dismal.files.file.iconRes
import com.dismal.files.file.isApk
import com.dismal.files.provider.archive.isArchivePath
import com.dismal.files.provider.common.isEncrypted
import com.dismal.files.settings.Settings
import com.dismal.files.ui.AnimatedListAdapter
import com.dismal.files.ui.CheckableForegroundLinearLayout
import com.dismal.files.ui.CheckableItemBackground
import com.dismal.files.util.isMaterial3Theme
